...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || `http://openapi.iveryone.test.wuyan.cn/Oauth2/Authorize${query}`;
  options.tokenURL = options.tokenURL || `http://openapi.iveryone.test.wuyan.cn/Oauth2/AccessToken${query}`;
  ...
  this.name = 'iveryone';
  this._userProfileURL = options.userProfileURL || `http://openapi.iveryone.test.wuyan.cn/Api/User/GetInfo${query}`;
